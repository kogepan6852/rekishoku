class AddColumnAboutShopInfoToShops < ActiveRecord::Migration
  def change
    add_column :shops, :daytime_max_price, :integer
    add_column :shops, :daytime_min_price, :integer
    add_column :shops, :nighttime_max_price, :integer
    add_column :shops, :nighttime_min_price, :integer
