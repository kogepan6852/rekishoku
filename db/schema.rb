...
ActiveRecord::Schema.define(version: 20170827230334) do
  ...
  create_table "address_books", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "tel"
  ...
  create_table "categories_people", id: false, force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_categories_people_on_person_id"
  end
  ...
  create_table "favorite_details", id: :serial, force: :cascade do |t|
  ...
  create_table "people_external_links", id: false, force: :cascade do |t|
    t.integer "person_id", null: false
    t.integer "external_link_id", null: false
    t.index ["external_link_id"], name: "index_people_external_links_on_external_link_id"
    t.index ["person_id"], name: "index_people_external_links_on_person_id"
  end

  create_table "people_periods", id: false, force: :cascade do |t|
    t.integer "person_id", null: false
    t.integer "period_id", null: false
    t.index ["period_id"], name: "index_people_periods_on_period_id"
    t.index ["person_id"], name: "index_people_periods_on_person_id"
  end

  create_table "people_shops", id: false, force: :cascade do |t|
    t.integer "person_id", null: false
    t.integer "shop_id", null: false
    t.index ["person_id"], name: "index_people_shops_on_person_id"
    t.index ["shop_id"], name: "index_people_shops_on_shop_id"
  end
  ...
  create_table "period_translations", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "name", null: false
    t.index ["locale"], name: "index_period_translations_on_locale"
    t.index ["period_id"], name: "index_period_translations_on_period_id"
  end
  ...
  create_table "scene_translations", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.text "description"
    t.index ["locale"], name: "index_scene_translations_on_locale"
    t.index ["scene_id"], name: "index_scene_translations_on_scene_id"
  end
  ...
  create_table "scenes_items", id: false, force: :cascade do |t|
    t.integer "scene_id", null: false
    t.integer "item_id", null: false
    t.index ["item_id"], name: "index_scenes_items_on_item_id"
    t.index ["scene_id"], name: "index_scenes_items_on_scene_id"
  end
  ...
  create_table "stories_shops", id: false, force: :cascade do |t|
    t.integer "story_id", null: false
    t.integer "shop_id", null: false
    t.index ["shop_id"], name: "index_stories_shops_on_shop_id"
    t.index ["story_id"], name: "index_stories_shops_on_story_id"
  end
  ...
  create_table "story_detail_translations", force: :cascade do |t|
    ...
    t.index ["locale"], name: "index_story_detail_translations_on_locale"
    t.index ["story_detail_id"], name: "index_story_detail_translations_on_story_detail_id"
  end

  create_table "story_details", id: :serial, force: :cascade do |t|
    t.integer "story_id"
    t.string "image"
    t.string "quotation_url"
    t.boolean "is_eye_catch", default: false
  ...
  create_table "story_relations", id: :serial, force: :cascade do |t|
    t.integer "story_id", null: false
